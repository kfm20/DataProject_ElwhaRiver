...
```{r Two Way T-Test REsults Total Water Discharge(Figure 10), echo=FALSE, message=FALSE, warning=FALSE, fig.cap="x"}
...
```{r Two Way T-Test REsults  Total sediment discharge(Figure 11), echo=FALSE, message=FALSE, warning=FALSE, fig.cap="x"}
ggplot(USGS_ElwhaRiverDischarge_TimeStamp) +
