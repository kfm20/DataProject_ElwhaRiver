...
geom_vline(data=d, mapping=aes(xintercept=date), color="skyblue4", lty=5, size=.5)+
  ...
  geom_text(data=d, mapping=aes
            ...
            size=3.5, angle=90, vjust=-0.4, hjust=0, color= "skyblue4", fontface="bold")+
  geom_text(x= as.Date("2016-02-01"), y=25, size = 3.5, label= "Mean Daily Discharge", color= "sienna3", vjust=-0.4, hjust=0, fontface="bold")+
  mytheme+
